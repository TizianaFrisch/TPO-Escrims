...
public class ApplicationConfig {
    ...
    public static class Matchmaking {
        ...
        public int getMmrDifferenceThreshold() { return mmrDifferenceThreshold; }
        public void setMmrDifferenceThreshold(int mmrDifferenceThreshold) { this.mmrDifferenceThreshold = mmrDifferenceThreshold; }
    ...
    public static class Moderation {
        ...
        public void setAutoBanThreshold(int autoBanThreshold) { this.autoBanThreshold = autoBanThreshold; }
        public int getAutoWarnThreshold() { return autoWarnThreshold; }
        public void setAutoWarnThreshold(int autoWarnThreshold) { this.autoWarnThreshold = autoWarnThreshold; }
    }
    
    public Matchmaking getMatchmaking() { return matchmaking; }
    public void setMatchmaking(Matchmaking matchmaking) { this.matchmaking = matchmaking; }
