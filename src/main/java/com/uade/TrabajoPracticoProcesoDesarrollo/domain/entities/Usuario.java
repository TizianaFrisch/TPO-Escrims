...
public class Usuario {
    ...
    public void setRegion(String region) { this.region = region; }
        ...
        // Exponer JSON compacto para evitar grafos profundos pero cumplir con tests
        @com.fasterxml.jackson.annotation.JsonProperty("juegoPrincipal")
        public java.util.Map<String, Object> getJuegoPrincipalJson() {
            if (this.juegoPrincipal == null) return null;
            Long jid = this.juegoPrincipal.getId();
            return java.util.Map.of("id", jid);
        }
